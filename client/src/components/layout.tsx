...
import { LayoutDashboard, Settings, Briefcase, Wallet, ClipboardList, Orbit, Lock, Sun, Moon, Newspaper, Clock, Stethoscope, Monitor, MoreHorizontal, BookOpen, X, Eye, Bot } from "lucide-react";
...
function Sidebar({ className }: SidebarProps) {
  ...
  const links = [
    ...
    { href: "/agents", label: "Agents Office", icon: Bot },
