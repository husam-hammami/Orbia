...
const QUICK_CHIPS = [
  { label: "How's my orbit?", prompt: "Check in with me — how's my day looking based on what you can see?" },
  { label: "What's lighting up?", prompt: "What patterns or wins are you noticing lately?" },
  { label: "I need gentle mode", prompt: "I'm feeling overwhelmed. Can you help me simplify things?" },
  { label: "Smallest next step", prompt: "What's the tiniest, most manageable thing I could do right now?" },
  { label: "Celebrate something", prompt: "Find me something to feel good about from my recent data" },
];
