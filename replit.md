...
- **Orbit AI Actions**: Review / Test / Push & Merge / Notify Me (replaced Analyze/Review/Plan/Monitor). Orbit reads full terminal buffer (500 chars session start + 10,000 chars recent), can execute terminal commands for all actions. System prompt positions Orbit as active orchestrator.
